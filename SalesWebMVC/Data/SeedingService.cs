...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d4 = new Department(4, "Jogos");

            Seller s1 = new Seller(1, "Primeiro Vendedor", "Primeiro@mail.com", 2000.0, new DateTime(1998, 5, 21), d1);
            Seller s2 = new Seller(2, "Segundo Vendedor", "Segundo@mail.com", 4000.0, new DateTime(1997, 5, 21), d2);
            Seller s3 = new Seller(3, "Terceiro Vendedor", "Terceiro@mail.com", 6000.0, new DateTime(1996, 5, 21), d3);
            Seller s4 = new Seller(4, "Quarto Vendedor", "Quarto@mail.com", 3500.0, new DateTime(1995, 5, 21), d4);
            Seller s5 = new Seller(5, "Quinto Vendedor", "Quinto@mail.com", 1000.0, new DateTime(1994, 5, 21), d1);
            Seller s6 = new Seller(6, "Sexto Vendedor", "Sexto@mail.com", 1800.0, new DateTime(1993, 5, 21), d2);
            Seller s7 = new Seller(7, "Setimo Vendedor", "Setimo@mail.com", 3600.0, new DateTime(1992, 5, 21), d3);
            Seller s8 = new Seller(8, "Oitavo Vendedor", "Oitavo@mail.com", 2500.0, new DateTime(1991, 5, 21), d4);
            Seller s9 = new Seller(9, "Nono Vendedor", "Nono@mail.com", 2000.0, new DateTime(1990, 5, 21), d1);
            Seller s10 = new Seller(10, "Decimo Vendedor", "Decimo@mail.com", 7000.0, new DateTime(1989, 5, 21), d1);
